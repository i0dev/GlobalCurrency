...
public abstract class AbstractCommand implements CommandExecutor, TabExecutor {
    ...
    protected void help(CommandSender sender, String[] args) {
        ...
        List<String> commands = Arrays.asList(
                "globalcurrency help",
                "globalcurrency reload",
                "globalcurrency version",
                "globalcurrency add <player> <amount>",
                "globalcurrency remove <player> <amount>",
                "globalcurrency set <player> <amount>",
                "globalcurrency shop",
                "globalcurrency balance",
                "globalcurrency pay <player> <amount>",
                "globalcurrency checkBal <player>"
        );
