...
public class ConfigManager extends AbstractManager {
    ...
    /**
     * Create new file for the main file and copy resource into it
     *
     * @param filePath - Path to file
    ...
    public void prepareFile(String filePath, String resource) {
        ...
        try {
            ...
            if (resource != null && !resource.isEmpty()) {
                this.copyResource(GlobalCurrencyPlugin.getPlugin().getResource(resource), file);
            }
    ...
    /**
     * Create new file for the mail file without resource
     *
    ...
    /**
     * Adds header block to the mail file
     *
    ...
    public String getPluginName() {
        return GlobalCurrencyPlugin.getPlugin().getDescription().getName();
    }
