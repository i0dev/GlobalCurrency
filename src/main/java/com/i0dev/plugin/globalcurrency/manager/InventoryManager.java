...
public class InventoryManager extends AbstractManager {
    ...
    public List<Category> getCategories() {
        ...
        for (Object obj : cnf.getList("categories")) {
    ...
    public void setupInventory() {
        SimpleConfig cnf = GlobalCurrencyPlugin.getPlugin().cnf();
        this.categoryInventory = Bukkit.createInventory(new ShopInventoryHolder(), cnf.getInt("shopInventorySize"), Utility.color(cnf.getString("shopInventoryTitle")));
