...
public class CmdGlobalCurrency extends AbstractCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        if (args.length == 0) {
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "version", "ver" -> version(sender, args);
                ...
                case "checkbal" -> checkBal(sender, args);

                default -> help(sender, args);
            }
        }
    }
    ...
    public void balance(CommandSender sender, String[] args) {
        ...
        MsgUtil.msg(sender, msg().getString("yourBalance"), new Pair<>("{amount}", String.valueOf(balance)));
    }
